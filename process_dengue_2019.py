...
def process_dengue_data_2019(input_file, output_file=None):
    """
    Procesa los datos de dengue/zika de 2019 al formato requerido para el modelo.
    ...
    print(f"📊 PROCESANDO DATOS DE 2019")
    ...
    print(f"\n🔍 ANALIZANDO DEPARTAMENTOS ÚNICOS EN 2019:")
...
if __name__ == "__main__":
    # Procesar el archivo de 2019
    input_file = "data/dengue_not_processed/dengue-zika.2019-12-31.csv"
    output_file = "data/dengue_processed_2019.csv"
    
    result_df = process_dengue_data_2019(input_file, output_file)
