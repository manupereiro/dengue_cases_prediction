...
def process_dengue_data_2023(input_file, output_file=None):
    """
    Procesa los datos de dengue/zika de 2023 al formato requerido para el modelo.
    Incluye todos los eventos transmitidos por Aedes aegypti (dengue y zika).
    Maneja el nuevo formato de columnas de 2023.
    
    Formato objetivo:
    | year | week | departament_name | departament_id | province | target_cases |
    
    Mapeo de columnas para 2023:
    ...
    print(f"📊 PROCESANDO DATOS DE 2023")
    ...
    print(f"\n🔍 ANALIZANDO DEPARTAMENTOS ÚNICOS EN 2023:")
...
if __name__ == "__main__":
    # Procesar el archivo de 2023
    input_file = "data/dengue_not_processed/dengue-zika.2023-12-31.csv"
    output_file = "data/dengue_processed_2023.csv"
    
    try:
        result_df = process_dengue_data_2023(input_file, output_file)
