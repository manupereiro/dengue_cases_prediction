...
def process_dengue_data_2024(input_file, output_file=None):
    """
    Procesa los datos de dengue/zika de 2024 al formato requerido para el modelo.
    Incluye todos los eventos transmitidos por Aedes aegypti (dengue y zika).
    Maneja problemas de codificación automáticamente y el formato de columnas de 2024.
    
    Formato objetivo:
    | year | week | departament_name | departament_id | province | target_cases |
    
    Mapeo de columnas para 2024:
    ...
    print(f"📊 PROCESANDO DATOS DE 2024")
    ...
    print(f"\n🔍 ANALIZANDO DEPARTAMENTOS ÚNICOS EN 2024:")
...
if __name__ == "__main__":
    # Procesar el archivo de 2024
    input_file = "data/dengue_not_processed/dengue-zika.2024-12-31.csv"
    output_file = "data/dengue_processed_2024.csv"
    
    # Nota: Puede ser necesario instalar chardet si no está disponible
    try:
        result_df = process_dengue_data_2024(input_file, output_file)
